...
const translations: Record<Lang, Record<string, string>> = {
  fr: {
    ...
    "hero.overlay.desc": "+20 ans d'expertise humaine à Ouagadougou",
    "hero.overlay.years": "ans",
    // Common
    ...
    "footer.desc": "Centre de référence à Ouagadougou depuis plus de 20 ans. Nous accompagnons particuliers, entreprises, ONG et institutions dans leur communication internationale — avec une expertise 100% humaine, confidentielle et certifiée.",
    "footer.formation": "Formation en anglais",
    "footer.traduction": "Traduction professionnelle",
    "footer.interpretation": "Interprétation",
    "footer.coaching": "Coaching linguistique",
    "footer.apropos": "À propos",
    "footer.galerie": "Galerie photos",
    "footer.pourquoi": "Pourquoi Humain vs IA",
    "footer.temoignages": "Témoignages",
    "footer.blog": "Blog & conseils",
    "footer.devis": "Demander un devis",
    "footer.inscrire": "S'inscrire à une formation",
    "footer.reserver": "Réserver un interprète",
    "footer.faq": "FAQ",
  ...
  en: {
    ...
    "hero.overlay.desc": "Over 20 years of human expertise in Ouagadougou",
    "hero.overlay.years": "years",
    // Common
    ...
    "footer.desc": "A leading language center in Ouagadougou for over 20 years. We support individuals, companies, NGOs and institutions in their international communication — with 100% human, confidential and certified expertise.",
    "footer.formation": "English Training",
    "footer.traduction": "Professional Translation",
    "footer.interpretation": "Interpreting",
    "footer.coaching": "Language Coaching",
    "footer.apropos": "About",
    "footer.galerie": "Photo Gallery",
    "footer.pourquoi": "Why Human vs AI",
    "footer.temoignages": "Testimonials",
    "footer.blog": "Blog & Tips",
    "footer.devis": "Get a quote",
    "footer.inscrire": "Register for a course",
    "footer.reserver": "Book an interpreter",
    "footer.faq": "FAQ",
